import { createProgram, createShader } from "./dsogl.js";

export function createBox(gl, scale) {
    var v_shader=`
...
const colors = [
    ...
    0.0,  0.0,  1.0,  1.0,    // untere Fläche: blau
    0.0,  0.0,  1.0,  1.0,    // untere boxFläche: blau
    0.0,  0.0,  1.0,  1.0,    // untere Fläche: blau
    ...
    function render(matrix) {
        ...
        gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, indexBuffer);
        if(matrix){
            var transUniformLocation = gl.getUniformLocation(program, "u_trans");
